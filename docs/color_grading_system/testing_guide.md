...
- [ ] Exposureスライダーが動作する
- [ ] Contrastスライダーが動作する
- [ ] Saturationスライダーが動作する
- [ ] Temperatureスライダーが動作する
- [ ] Tintスライダーが動作する

#### カラーホイール（Lift/Gamma/Gain 縦並列表示）
- [ ] Lift（シャドウ）カラーホイールが表示される
- [ ] Gamma（ミッドトーン）カラーホイールが表示される
- [ ] Gain（ハイライト）カラーホイールが表示される
- [ ] カラーホイール上でドラッグすると色相と彩度が調整できる
- [ ] 右側のスライダーで輝度（Luminance）が調整できる
- [ ] カラーホイール操作時にノードが誤って選択されない

#### 全体動作
- [ ] プレビューがリアルタイムで更新される
- [ ] 動画プレビュー時もスライダーがスムーズに動作する
- [ ] 各リセットボタンが正常に動作する
