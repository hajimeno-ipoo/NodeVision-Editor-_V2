export const UI_TRANSLATIONS = {
  'en-US': {
    ...
    'nodes.trim.modalPlaceholder.video': 'Video trim modal is coming soon—set accurate in/out ranges in a dedicated workspace.',
  ...
  'ja-JP': {
    ...
    'nodes.trim.tip': 'ソースをつないで専用モーダルでIN/OUTやクロップを決めておくと、その後の重い処理が超ラクになるよ。',
    'nodes.trim.imageButton': '画像トリム',
    'nodes.trim.videoButton': '動画トリム',
    'nodes.trim.status.empty': 'まだ設定されていません',
    'nodes.trim.status.imageEdited': '画像クロップ済み',
    'nodes.trim.status.videoEdited': '動画トリム済み',
    'nodes.trim.status.imageSummary': '画像 {{width}}% × {{height}}% で表示中',
    'nodes.trim.status.videoSummary': '動画 {{start}} → {{end}}{{strict}}',
    'nodes.trim.status.videoEndLabel': '最後',
    'nodes.trim.status.videoStrictSuffix': '（キッチリ）',
    ...
    'nodes.trim.modalPlaceholder.image': 'ハイライトされた枠や角をドラッグして、表示中の画像をトリミングしてね。',
    'nodes.trim.modalPlaceholder.video': '動画トリム専用モーダルはまもなく登場。IN/OUTを正確に設定できる編集スペースになるよ。',
    'nodes.trim.modalPlaceholder.noImage': '先に画像ロードノードを接続してメディアを選んでね。',
    'nodes.trim.toast.imageSaved': '画像のトリム設定を保存したよ。',
    'nodes.trim.toast.videoSaved': '動画のトリム設定を保存したよ。',
    'nodes.mediaPreview.trimmedBadge': 'トリム結果',
    'nodes.mediaPreview.trimmedRange': '範囲 {{start}} → {{end}}{{strict}}',
    'nodes.mediaPreview.trimmedCrop': 'トリム {{width}}% × {{height}}%',
    'nodes.trim.modalPlaceholder.noVideo': '先に動画ロードノードをつなげてプレビューをつくってからトリムしてね。',
    'nodes.trim.modalHint.video': 'タイムラインのハンドルか時間入力でIN/OUTを決めて、保存すれば下流にも反映されるよ。',
    'nodes.trim.video.previewFallback': '動画ソース',
    'nodes.trim.video.startLabel': '開始',
    'nodes.trim.video.endLabel': '終了',
    'nodes.trim.video.durationUnknown': '長さは未取得',
    'nodes.trim.video.strictLabel': 'キッチリカット',
    'nodes.trim.video.strictHint': '指定範囲の外はフレームごと捨てるよ。',
    'nodes.trim.video.controls.play': '再生',
    'nodes.trim.video.controls.pause': '一時停止',
    'nodes.trim.video.controls.stepBack': '1コマ戻す',
    'nodes.trim.video.controls.stepForward': '1コマ進める',
    'nodes.trim.video.startHandle': '開始ハンドル',
    'nodes.trim.video.endHandle': '終了ハンドル',
