export const UI_TRANSLATIONS = {
  'en-US': {
    ...
    'nodes.trim.startLabel': 'Start',
    'nodes.trim.endLabel': 'End',
    'nodes.trim.strictLabel': 'Strict cut',
    'nodes.trim.timelineLabel': 'Trim timeline',
    'nodes.trim.unset': 'Unset',
  ...
  'ja-JP': {
    ...
    'nodes.trim.startLabel': '開始',
    'nodes.trim.endLabel': '終了',
    'nodes.trim.strictLabel': 'ハードカット',
    'nodes.trim.timelineLabel': 'トリムタイムライン',
    'nodes.trim.unset': '未設定',
