...
export const captureDomElements = (): RendererDom => ({
  ...
  selectionRect: getElement<HTMLElement>('selection-rect'),
  selectionOutline: getElement<HTMLElement>('selection-outline'),
  nodeLayer: getElement<HTMLElement>('node-layer'),
  connectionLayer: getElement<SVGSVGElement>('connection-layer'),
  toolSelect: getElement<HTMLButtonElement>('tool-select'),
  toolPan: getElement<HTMLButtonElement>('tool-pan'),
  fitView: getElement<HTMLButtonElement>('btn-fit-view'),
  zoomDisplay: getElement<HTMLButtonElement>('zoom-display'),
  zoomMenu: getElement<HTMLElement>('zoom-menu'),
  zoomIn: getElement<HTMLButtonElement>('zoom-in'),
  zoomOut: getElement<HTMLButtonElement>('zoom-out'),
  zoomFitMenu: getElement<HTMLButtonElement>('zoom-fit-menu'),
  zoomApply: getElement<HTMLButtonElement>('zoom-apply'),
  zoomInput: getElement<HTMLInputElement>('zoom-input'),
